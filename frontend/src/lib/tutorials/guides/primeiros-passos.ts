...
export const primeirosPassosGuides: TutorialGuide[] = [
  {
    ...
    steps: [
      ...
      'Role a página para ver demografia, estrutura da igreja, ministérios e mapa geográfico.',
  ...
  },
  {
    ...
    title: 'Criar seu primeiro ministério',
    module: 'grupos',
    role: 'editor',
    route: '/ministries',
    estimatedMinutes: 3,
    tags: ['início', 'ministério'],
    steps: [
      ...
      'Clique em Salvar.',
      'Abra o ministério e adicione membros à composição.',
    ],
    details: [
