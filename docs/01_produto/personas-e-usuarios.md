...
- **Casos de uso (milestone):** login + console read-only de Igrejas (overview, lista, ficha) + tela **Saúde** (`/health`) em `admin-ops/` `:3002` via `/api/ops`. Waitlist — **ainda não** (DEV-72).
