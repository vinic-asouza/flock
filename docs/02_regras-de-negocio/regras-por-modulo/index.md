...
| Admin OPS | [[02_regras-de-negocio/regras-por-modulo/admin-ops]] | OPS | 7 | Allowlist + leitura GET de Igrejas + saúde agregada |
...
2026-08-26 — BR-OPS-007 (saúde agregada `GET /api/ops/health`, DEV-76).
