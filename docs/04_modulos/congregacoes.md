...
├── validators/
│   └── congregationValidator.ts   → Joi create/update + exportCongregationMembersListSchema
├── utils/
...
| 2026-08-25 | 1.3 | Modal view: Exportar lista de membros ativos (PDF via Relatórios, BR-REL-012) | DEV-47 |
...
| Jobs | Nenhum |
| Testes | Validator do export de membros (`congregationValidator.test.ts`) |
